...
namespace CoC.Items
{
	...
	public class HairFurColors : EpidermalColors
	{
		...
		public static readonly HairFurColors NO_HAIR_FUR = new HairFurColors(Color.Transparent, "");
		...
		public static readonly HairFurColors CARAMEL = new HairFurColors(Color.Peru, "caramel");
