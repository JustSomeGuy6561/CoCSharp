...
{
	internal sealed partial class Deepwoods
	{
		private static string DeepwoodsName()
		{
			return "Deepwoods";
		}
		private static string DeepwoodsUnlock()
		{
			return "After exploring the forest so many times, you decide to really push it, and plunge deeper and deeper into the woods. The further you go the darker it gets, " +
				...
				"the entrance to the 'Deepwoods'. You don't press on for now, but you could easily find your way back should you decide to later." +
				Environment.NewLine + Environment.NewLine + SafelyFormattedString.FormattedText("You've discovered the Deepwoods!", StringFormats.BOLD);
		}
