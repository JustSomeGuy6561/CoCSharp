...
#pragma warning restore CS0162 // Unreachable code detected
			...
			{
				return "Your crotch twitches, and you pull open your " + target.armor.ItemName() + " to get a better look. You watch in horror " +
			...
			//	{
			//		return GlobalStrings.NewParagraph() + "Your " + oldData.fullDescription() + " clenches painfully, becoming achingly, throbbingly erect. A tightness seems to squeeze around the base," +
			...
			//	{
			//		return GlobalStrings.NewParagraph() + "Your " + oldData.shortDescription() + " shrinks, the extra equine length seeming to shift into girth. The flared tip vanishes into a more pointed form, " +
			...
			//	{
			//		return GlobalStrings.NewParagraph() + "Your " + oldData.fullDescription() + " coils in on itself, reshaping and losing its plant-like coloration as it thickens near the base, " +
			...
			//	{
			//		return GlobalStrings.NewParagraph() + "Your " + oldData.fullDescription() + " trembles, reshaping itself into a shiny red doggie-dick with a fat knot at the base. " +
			//			SafelyFormattedString.FormattedText("You now have a dog-cock.", StringFormats.BOLD);
			//	}
			//	//return "";
			//}
			...
			protected override string GrowCurrentBreastRowText(Creature target, int index, byte increaseAmount, bool previousRowsGrew, bool moreRowsToGrow)
			{
				...
				if (!previousRowsGrew)
				{
					...
					return GlobalStrings.NewParagraph() + "Your " + breast.LongDescription() + " feel constrained and painful against your top as they grow larger by the moment, finally stopping as they reach " +
