...
namespace CoC.Backend.BodyParts
{
	...
	[DataContract]
	public class Horns : BehavioralSaveablePart<Horns, HornType>, IGrowShrinkable
	{
...
CanGrowPlus())
		...
		private protected override Type currentSaveVersion => typeof(HornSurrogateVersion1);
		private protected override Type[] saveVersions => new Type[] { typeof(HornSurrogateVersion1) };
		private protected override BehavioralSurrogateBase<Horns, HornType> ToCurrentSave()
		{
		...
		internal Horns(HornSurrogateVersion1 surrogate)
		{
			...
			_numHorns = surrogate.numHorns;
			_significantHornSize = surrogate.hornLength;
		}
		#endregion
	}
	...
	[DataContract]
	public sealed class HornSurrogateVersion1 : BehavioralSurrogateBase<Horns, HornType>
	{
		[DataMember]
		public int hornType;
		[DataMember]
