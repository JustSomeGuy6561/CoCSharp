...
{
	[DataContract]
	public class Wings : BehavioralSaveablePart<Wings, WingType>, IDyeable, IToneable
	{
		//add to creature. 
		...
		internal override bool Validate(bool correctDataIfInvalid = false)
		{
			...
			var tone = wingTone;
			bool valid = WingType.Validate(ref wingType, ref feather, ref tone, correctDataIfInvalid);
			type = wingType;
		...
		private protected override Type[] saveVersions => new Type[] { typeof(WingSurrogateVersion1) };
		private protected override Type currentSaveVersion => typeof(WingSurrogateVersion1);
		private protected override BehavioralSurrogateBase<Wings, WingType> ToCurrentSave()
		{
		...
		internal Wings(WingSurrogateVersion1 surrogate)
		{
			...
			wingTone = !Tones.isNullOrEmpty(surrogate.wingTone) ? surrogate.wingTone : type.defaultTone;
			featherColor = !HairFurColors.isNullOrEmpty(surrogate.featherColor) ? surrogate.featherColor : type.defaultFeatherColor;
	...
	public partial class WingType : SaveableBehavior<WingType, Wings>
	{
		...
		internal static bool Validate(ref WingType wingType, ref HairFurColors featherCol, ref Tones wingTone, bool correctInvalidData = false)
		{
			bool valid = true;
	...
	[DataContract]
	public sealed class WingSurrogateVersion1 : BehavioralSurrogateBase<Wings, WingType>
	{
		[DataMember]
		public int wingType;
