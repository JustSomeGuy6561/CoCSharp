...
namespace CoC.Backend.BodyParts
{
	...
	[DataContract]
	public abstract class BehavioralSaveablePart<ThisClass, BehaviorClass> : BehavioralPartBase<BehaviorClass>/*, ISaveableBase*/ where ThisClass : BehavioralSaveablePart<ThisClass, BehaviorClass> where BehaviorClass : SaveableBehavior<BehaviorClass, ThisClass>
	{
