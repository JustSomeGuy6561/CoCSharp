...
namespace CoC.Backend.BodyParts
{
	...
	[DataContract]
	public class Ears : BehavioralSaveablePart<Ears, EarType>, IBodyAware
	{
		...
		public Piercing<EarPiercings> earPiercings;
		...
		private protected override Type currentSaveVersion => typeof(EarSurrogateVersion1);

		private protected override Type[] saveVersions => new Type[] { typeof(EarSurrogateVersion1) };

		private protected override BehavioralSurrogateBase<Ears, EarType> ToCurrentSave()
		{
		...
		internal Ears(EarSurrogateVersion1 surrogate)
		{
			...
			earPiercings = surrogate.earPiercings;
		}
	}
	...
	[DataContract]
	[KnownType(typeof(Piercing<EarPiercings>))]
	public sealed class EarSurrogateVersion1 : BehavioralSurrogateBase<Ears, EarType>
	{
		[DataMember]
		public int earType;
		[DataMember]
