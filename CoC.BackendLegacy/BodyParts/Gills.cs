...
{
	[DataContract]
	public class Gills : BehavioralSaveablePart<Gills, GillType>
	{
		protected Gills()
		{
			type = GillType.NONE;
		...
		private protected override Type currentSaveVersion => typeof(GillSurrogateVersion1);
		private protected override Type[] saveVersions => new Type[] { typeof(GillSurrogateVersion1) };

		private protected override BehavioralSurrogateBase<Gills, GillType> ToCurrentSave()
		{
	...
	[DataContract]
	public sealed class GillSurrogateVersion1 : BehavioralSurrogateBase<Gills, GillType>
	{
		[DataMember]
		public int gillType;
