...
namespace CoC.Backend.BodyParts
{
	...
	[DataContract]
	public sealed partial class Epidermis : BehavioralPartBase<EpidermisType>, ISaveableBase
	{
		...
		Type ISaveableBase.currentSaveType => typeof(EpidermisSurrogateVersion1);

		Type[] ISaveableBase.saveVersionTypes => new Type[] { typeof(EpidermisSurrogateVersion1) };
	...
	public sealed class EpidermisSurrogateVersion1 : ISurrogateBase
	{
		[DataMember]
