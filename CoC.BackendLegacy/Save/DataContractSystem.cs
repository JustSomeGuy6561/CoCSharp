...
namespace CoC.Backend.Save
{
	public static class DataContractSystem
	{
		...
		public static Type[] testingKnownTypes()
		{
			return System.Linq.Enumerable.ToArray(knownTypes);
		}
		...
		internal static DataContractSerializer getSerializer()
		{
			...
			DataContractSerializer dcs = new DataContractSerializer(typeof(SaveableData[]), dcss);
	...
	internal class SaveSurrogate : ISerializationSurrogateProvider
	{
		...
		public object GetDeserializedObject(object obj, Type targetType)
		{
			foreach (Type data in DataContractSystem.allSurrogates)
			{
				...
				{
					return ((ISurrogateBase)obj).ToSaveable();
				}
			}
			return obj;
		}
