...
namespace CoC.Backend.CoC_Colors
{
	...
	[DataContract]
	public class FurColor : SaveClassBase
	{
		...
		protected override Type currentSave => typeof(FurSurrogateVersion1);
		protected override Type[] saveVersions => new Type[] { typeof(FurSurrogateVersion1) };
