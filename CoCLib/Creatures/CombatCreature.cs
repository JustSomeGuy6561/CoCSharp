...
namespace CoC.Creatures
{
	...
	internal abstract class CombatCreature : Creature
	{
		...
		public override CreatureCreator creator => combatCreator;
		public abstract CombatCreatureCreator combatCreator { get; }
	}

	internal abstract class CombatCreatureCreator : CreatureCreator
	{
		public float level;
		...
		public ArmAccessory armAccessory;
		public NeckAccessory neckAccessory;
		public HairAccessory hairAccessory;
	}
}
