...
namespace CoC.Backend.Reaction
{
	...
	public sealed class OneOffTimeReactionBase : IComparable<OneOffTimeReactionBase>
	{
		public readonly GameDateTime procTime;
		public readonly TimeReactionBase onProc;

		//fires immediately.
		public OneOffTimeReactionBase(TimeReactionBase doProc)
		{
		...
		public OneOffTimeReactionBase(TimeReactionBase doProc, byte delay, bool randomized = false)
		{
			onProc = doProc ?? throw new ArgumentNullException(nameof(doProc));
		...
		public int CompareTo(OneOffTimeReactionBase other)
		{
