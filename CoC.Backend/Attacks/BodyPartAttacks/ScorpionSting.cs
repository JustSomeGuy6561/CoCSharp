...
{
	public sealed partial class ScorpionSting : ResourceAttackBase
	{
		...
		internal ScorpionSting(Func<ushort> getResourceCount, Action<ushort> setResourceCount) : base(MAX_CHARGE, MIN_RECHARGE, MAX_RECHARGE, INITIAL_AMOUNT, INITIAL_RECHARGE, getResourceCount, setResourceCount, Attack)
		{
