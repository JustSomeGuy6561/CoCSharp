...
namespace CoC.Backend.Attacks.BodyPartAttacks
{
	public sealed partial class BeeSting : ResourceAttackBase
	{
		...
		internal BeeSting(Func<ushort> getResourceCount, Action<ushort> setResourceCount) : base(MAX_CHARGE, MIN_RECHARGE, MAX_RECHARGE, INITIAL_AMOUNT, INITIAL_RECHARGE, getResourceCount, setResourceCount, Attack) { }
