...
namespace CoC.Backend.BodyParts
{
	public partial class BodyType
	{
		...
		#endregion
		#region Feather
		protected static string FeatherDesc()
		{

		}
		protected static string FeatherUnderbodyDesc()
		{

		}
		protected static string FeatherFullDesc(Body body)
		{

		}
		protected static string FeatherPlayerStr(Body body, Player player)
		{

		}
		protected static string FeatherTransformStr(Body body, Player player)
		{

		}
		protected static string FeatherRestoreStr(Body body, Player player)
		{
