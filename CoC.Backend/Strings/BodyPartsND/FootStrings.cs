...
namespace CoC.Backend.BodyParts
{
	...
	public sealed partial class FootType
	{
		...
		private static string HoovesDesc()
		{
			throw new Tools.InDevelopmentExceptionThatBreaksOnRelease();
		}
		...
		private static string DemonHeelDesc()
		{
			throw new Tools.InDevelopmentExceptionThatBreaksOnRelease();
		}
		...
		private static string InsectoidDesc()
		{
			throw new Tools.InDevelopmentExceptionThatBreaksOnRelease();
		}
		...
		private static string LizardClawDesc()
		{
			throw new Tools.InDevelopmentExceptionThatBreaksOnRelease();
		}
		...
		private static string BronyDesc()
		{
			throw new Tools.InDevelopmentExceptionThatBreaksOnRelease();
		}
		...
		private static string RabbitDesc()
		{
			throw new Tools.InDevelopmentExceptionThatBreaksOnRelease();
		}
		...
		private static string HarpyTalonDesc()
		{
			throw new Tools.InDevelopmentExceptionThatBreaksOnRelease();
		}
		...
		private static string DragonClawDesc()
		{
			throw new Tools.InDevelopmentExceptionThatBreaksOnRelease();
		}
		...
		private static string ManderClawDesc()
		{
			throw new Tools.InDevelopmentExceptionThatBreaksOnRelease();
		}
		...
		private static string ImpClawDesc()
		{
			throw new Tools.InDevelopmentExceptionThatBreaksOnRelease();
		}
