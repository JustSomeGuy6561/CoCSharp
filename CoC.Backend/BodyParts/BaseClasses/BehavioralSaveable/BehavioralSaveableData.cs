...
namespace CoC.Backend.BodyParts
{
	...
	/// </remarks>
	public abstract class BehavioralSaveableData<DataClass, SourceClass, BehaviorClass> : BehavioralPartDataBase<BehaviorClass>
		where DataClass : BehavioralSaveableData<DataClass, SourceClass, BehaviorClass>
		where SourceClass : BehavioralSaveablePart<SourceClass, BehaviorClass, DataClass>
		where BehaviorClass : BehaviorBase

	{
		private protected BehavioralSaveableData(Guid creatureID, BehaviorClass currentBehavior) : base(creatureID, currentBehavior)
		{
		}
