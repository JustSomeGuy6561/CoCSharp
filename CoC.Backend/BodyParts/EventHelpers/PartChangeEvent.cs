...
{
	public sealed class BodyPartChangedEventArg<DataClass, BehaviorClass> : EventArgs where DataClass : BehavioralPartDataBase<BehaviorClass> where BehaviorClass : BehaviorBase
	{
